    ...
    <div className="pt-28 pb-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <motion.div
          ...
          className="rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/5 to-transparent p-12 mb-24"
        >
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {differentials.map((item) => (
              <div key={item.label} className="text-center">
                <div className="text-4xl sm:text-5xl font-bold text-primary mb-2">{item.value}</div>
